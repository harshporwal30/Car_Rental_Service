# -*- coding: utf-8 -*-
"""
Created on Wed Jan 17 20:23:49 2024
...
while True:
    ...
    if option == 1:
        ...
        for i, car in cars.items():
            if car["available"]:
                print(
                    f"Car ID: {car['id']}, Brand: {car['brand']}, Hourly Rate: ₹{car['rent']}")
        ...
        for car_name, car in cars.items():
            if car["id"] == car_id and car["available"]:
                ...
                print(
                    f"{name} has rented a car for {hours} hours. Your Bill Amount: ₹{customer_info['bill_amount']}")
                car["available"] = False
        ...
        for customer in customers:
            print(
                f"Customer Name: {customer['c_name']}, Car ID: {customer['car_id']}, Rented Car: {customer['rented_car']}, Hours: {customer['hours']}, Bill Amount: ₹{customer['bill_amount']}")
